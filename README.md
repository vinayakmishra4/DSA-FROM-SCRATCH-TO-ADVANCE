<div align="center">
  ...
  <img src="https://img.shields.io/github/forks/vinayakmishra4/DSA-FROM-SCRATCH-TO-ADVANCE?style=for-the-badge"/>
</div>
...
## 📑 Table of Contents
Navigate quickly through the repository:
...
## 🧩 Modules:
Start your journey with **hands-on phases** packed with curated problems, clean Java solutions, and explanations you’ll love.
...
| Quick Sort      | [Read](https://github.com/vinayakmishra4/DSA-FROM-SCRATCH-TO-ADVANCE/blob/main/Sort-Algo/Quick_Sort.py
) | [python](https://github.com/vinayakmishra4/DSA-FROM-SCRATCH-TO-ADVANCE/blob/main/Sort-Algo/Quick_Sort.java) | Avg: O(n log n), Worst: O(n²) |
...
Here’s the updated table with the new problem added:
...
| ⭐ Rearrange Array                | Rearrange elements in alternate positive and negative order                | [Code](https://github.com/vinayakmishra4/DSA-FROM-SCRATCH-TO-ADVANCE/blob/main/Medium-Array/RearrangeArray.py)      |
| ⭐ Next Permutation               | Rearrange numbers into lexicographically next greater permutation          | [Code](https://github.com/vinayakmishra4/DSA-FROM-SCRATCH-TO-ADVANCE/blob/main/Medium-Array/nextpermutation.py)     |
...
| 🔢 Find the Smallest Divisor               | Find the smallest divisor such that the sum of divisions is ≤ threshold (binary search on answer space)               | [Code](https://github.com/vinayakmishra4/DSA-FROM-SCRATCH-TO-ADVANCE/blob/main/Binary-Sreach-1D/Smalldivsor.java)           |
...
| ⭐ Largest Number in the String | Extract and return the largest numerical value present in the string.                            | [Code](https://github.com/vinayakmishra4/DSA-FROM-SCRATCH-TO-ADVANCE/blob/main/String-Easy/Largestoddnumber.java) |
